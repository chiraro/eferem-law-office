...
export default function PracticeAreas() {
  return (
    <div className='w-full flex flex-col items-center gap-14 px-[100px]'>
        <h2 className='text-[60px] text-[#3a3a38] font-semibold'>Our Practice Areas</h2>
        <div className="w-full flex flex-wrap justify-between gap-24">
            {practiceAreas?.slice(0, 4).map((area, index) => (
                <div key={index} className="max-w-[570px] px-12 py-10 bg-[#085AA3] rounded-lg flex flex-col gap-5">
