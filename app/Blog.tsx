        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-14">
            {blogs?.slice(0, 4).map((blog, index) => (
                <div key={index} className='w-full lg:max-w-[600px] flex flex-col sm:flex-row gap-5 items-center'>
                    <div className="relative w-full sm:w-[400px] h-[300px] sm:h-full bg-red-500">
                        <Image className='w-full h-full object-cover' src={blog.image} alt={blog.title} width={1080} height={1920} quality={100} />
                    </div>
