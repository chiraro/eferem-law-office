...
export default function AboutUs() {
  return (
    <div className='w-full my-[130px] flex items-center'>
        <div className="w-full p-[100px] px-[120px] flex items-center gap-[100px] bg-[#E8E9E1]">
            <div className="flex-[1]">
                <Image className='w-[250px] h-[250px] object-contain' src="/images/Logo_grey.png" alt="About Us" width={500} height={500} />
            </div>
            <div className="flex-[2.5] flex flex-col pl-[120px] border-l-2 border-[#085AA3]">
                <h2 className='text-[47px] leading-[4.25rem] text-[#085AA3] mb-5'>Integrity And Exceptional Legal Expertise</h2>
