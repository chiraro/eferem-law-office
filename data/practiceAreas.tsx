import { MdBalance, MdEngineering, MdOutlineShoppingCart } from "react-icons/md";
...
const practiceAreas = [
    {
        id: "1",
        title: 'Commercial & Financial Service',
        services: [
    ...
    },
    {
        ...
        services: [
            ...
            "General litigation representing Clients which includes amongst others",
            "Tax tribunals.",
        ],
        icon: <FaPeopleGroup />,
    },
